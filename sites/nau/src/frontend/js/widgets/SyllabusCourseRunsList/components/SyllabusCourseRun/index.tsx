...
import CourseRunEnrollment from 'richie-education/js/widgets/SyllabusCourseRunsList/components/CourseRunEnrollment';
import CourseProductItem from 'richie-education/js/widgets/CourseProductItem';
